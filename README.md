...
功能选项是一种[设计模式](https://github.com/glenshappy/uber_go_guide_cn/blob/master/design_patterns.md)，您可以在其中声明一个不透明 Option 类型，该类型在某些内部结构中记录信息。您接受这些选项的可变编号，并根据内部结构上的选项记录的全部信息采取行动。
